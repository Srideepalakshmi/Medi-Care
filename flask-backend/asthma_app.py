...
# === Load CSV file ===
df = pd.read_csv("flask-backend/Asthma_Analyzer.csv")

# === Extract symptom columns ===
symptom_columns = [col for col in df.columns if col not in ["Age", "Gender", "class", "Disease", "Suggestion"]]

# === Load model and vectorizer ===
model = joblib.load("flask-backend/asthma_model.pkl")
vectorizer = joblib.load("flask-backend/asthma_vectorizer.pkl")
    ...
    <header>
        ...
        <nav class="navbar">
            <ul>
                ...
                <li><a href="http://127.0.0.1:5502/index.html#about">about</a></li>
                <li><a href="http://127.0.0.1:5502/index.html#Vitality">Vitality</a></li>
                <li><a href="http://127.0.0.1:5502/index.html#review">Reviews</a></li>
                <li><a href="http://127.0.0.1:5502/index.html#News">News</a></li>
                  <li><a href="http://127.0.0.1:5502/index.html#contact">contact</a></li>
...
<script type="text/javascript">
 ...
 <div class="container"><br><br><br>
        <h2 style="font-size: 3.2rem; color: #0188df;">Asthma Analyzer</h2><br><br>
        ...
        <div class="result" id="result">
            ...
            <p><b>Diabetes Type:</b> <span id="Disease"></span></p><br><br>
...
if __name__ == "__main__":
    port = int(os.environ.get("PORT", 5002))  # Render provides PORT dynamically
