...
model = joblib.load("flask-backend/dia_model.pkl")
vectorizer = joblib.load("flask-backend/dia_vectorizer.pkl")
...
<script type="text/javascript">
 ...
 <div class="container"><br><br><br>
        <h2 style="font-size: 3.2rem; color: #0188df;">Diabetes Disease Analyzer</h2><br><br>
    ...
    try:
        ...
        if len(selected_symptoms) < 3:
            return jsonify({
                "Prediction": "Negative",
                "Disease": "None",
                "Suggestion": "No diabetes detected. Maintain a healthy lifestyle. Consult a general physician if symptoms persist."
            })
...
if __name__ == "__main__":
    port = int(os.environ.get("PORT", 5004))  # Render provides PORT dynamically
