...
model = joblib.load("flask-backend/ann_model.pkl")  # Use joblib.load for scikit-learn model
...
# Initialize doctor_map (If not available, you can create a basic one)
doctor_map = {
    'fever': 'a general physician',
    'cold': 'an ENT specialist',
    'headache': 'a neurologist'
    # Add more disease-doctor mappings here
}
