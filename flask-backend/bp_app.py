...
<script type="text/javascript">
 ...
 <div class="container"><br><br><br>
        <h2 style="font-size: 3.2rem; color: #0188df;"> Blood Pressure Analyzer</h2><br><br>
    ...
    try:
        ...
        if len(selected_symptoms) < 3:
            return jsonify({
                "Prediction": "Negative",
                "Disease": "None",
                "Suggestion": "No Blood Pressure detected. Maintain a healthy lifestyle. Consult a general physician if symptoms persist."
            })
