...
# === Load CSV file ===
df = pd.read_csv("flask-backend/Anemia_Analyzer.csv")

# === Extract symptom columns ===
symptom_columns = [col for col in df.columns if col not in ["Age", "Gender", "class", "Disease", "Suggestion"]]

# === Load model and vectorizer ===
model = joblib.load("flask-backend/anemia_model.pkl")
vectorizer = joblib.load("flask-backend/anemia_vectorizer.pkl")
...
<script type="text/javascript">
 ...
 <div class="container"><br><br><br>
        <h2 style="font-size: 3.2rem; color: #0188df;">Anemia Analyzer</h2><br><br>
    ...
    try:
        ...
        if len(selected_symptoms) < 3:
            return jsonify({
                "Prediction": "Negative",
                "Disease": "None",
                "Suggestion": "No Anemia disease detected. Maintain a healthy lifestyle. Consult a general physician if symptoms persist."
            })
...
if __name__ == "__main__":
    port = int(os.environ.get("PORT", 5001))  # Render provides PORT dynamically
